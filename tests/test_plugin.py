...
class TestPlugin:
    ...
    def test_track_filter_skips_tracks(self, caplog, temp_repo, example, run):
        expected_map = {
            ...
            "test-track2,test-track": { "test-track", "test-track2", "many-tracks/sub-track2" },
            "test-track500": set(),
            "many-tracks": { "many-tracks/sub-track", "many-tracks/sub-track2", "test-track", "test-track3" },
            "many-tracks/sub-track": { "many-tracks/sub-track" },
        }
